  ...
  return (
    <div className="relative rounded-2xl border border-primary/30 bg-primary/10 px-5 py-4 text-left shadow-[0_0_24px_rgba(220,38,38,0.12)]">
      ...
      <div className="flex items-start gap-3">
        <div className="mt-0.5 rounded-lg bg-primary/20 p-2 shrink-0">
        ...
        <div className="space-y-2">
          ...
          <Link
            ...
            className="inline-block rounded-full bg-primary px-5 py-2 text-xs font-black tracking-widest uppercase text-white hover:brightness-110 transition-all"
          >
            Learn More
          </Link>
        </div>
