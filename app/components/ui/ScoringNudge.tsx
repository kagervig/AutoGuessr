    ...
    <div className="relative rounded-2xl border border-primary/30 bg-primary/10 px-5 py-4 text-left shadow-[0_0_24px_rgba(220,38,38,0.12)]">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm sm:text-base font-black tracking-wide text-white">Want a higher score?</p>
          <p className="text-xs sm:text-sm text-white/60 leading-relaxed">
            Learn how points are calculated — make, model, year, speed, and difficulty all factor in.
          </p>
          <Link
            href={`/scoring?mode=${mode}`}
            className="mt-2 inline-block sm:hidden rounded-lg bg-primary px-3 py-1.5 text-xs font-black tracking-widest uppercase text-white hover:brightness-110 transition-all self-end ml-auto"
          >
            Learn More
          </Link>
        </div>
